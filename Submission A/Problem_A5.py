...
Original file is located at
    https://colab.research.google.com/drive/1Nujm_HTAocm_gqONk1vKRg_BmYGB4alO
"""
...
def solution_A5():
    ...
    model=tf.keras.models.Sequential([
      # YOUR CODE HERE.
      tf.keras.layers.Dense(10, input_shape = [None, 1], activation = 'relu'),
      tf.keras.layers.Dense(1)
    ])

    # YOUR CODE
    model.compile(loss='mae', optimizer=tf.keras.optimizers.SGD(learning_rate=1e-7, momentum=0.9), metrics=['mae'])
