...
Original file is located at
    https://colab.research.google.com/drive/1d4Em647CQurEHKmvwykjLJQTHGK1XVlF
"""
...
def solution_B4():
    ...
    ssq_training_label = np.array(label_tokenizer.texts_to_sequences(training_labels))
    ssq_validation_label = np.array(label_tokenizer.texts_to_sequences(validation_labels))
    ...
    model.fit(train_padded, ssq_training_label, epochs = 30,
              validation_data = (validation_padded, ssq_validation_label),
              verbose = 2)
